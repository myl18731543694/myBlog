...
<link rel="stylesheet" type="text/css" href="/websiteManagement/css/common.css" />
<link rel="stylesheet" type="text/css" href="/websiteManagement/css/slide.css" />
<link rel="stylesheet" type="text/css" href="/websiteManagement/css/bootstrap.min.css" />
<link rel="stylesheet" type="text/css" href="/websiteManagement/css/flat-ui.min.css" />
<link rel="stylesheet" type="text/css" href="/websiteManagement/css/jquery.nouislider.css">
</head>
...
<body>
	<div id="wrap">
		...
		<div class="leftMeun" id="leftMeun">
			<div id="logoDiv">
				<p id="logoP">
					<img id="logo" alt="左右结构项目" src="/websiteManagement/images/logo.png"><span>左右结构项目</span>
				</p>
			</div>
			<div id="personInfor">
				<p id="userName">杨鹏</p>
				<p>
					<span>yangxp@qq.com</span> More Templates
				</p>
				<p>
					<a>退出登录</a>
				</p>
			...
			<div class="meun-item meun-item-active" href="#sour"
				...
				<img src="/websiteManagement/images/icon_source.png">资源管理
			</div>
			<div class="meun-item" href="#char" aria-controls="char" role="tab"
				data-toggle="tab">
				<img src="/websiteManagement/images/icon_chara_grey.png">权限管理
			</div>
			<div class="meun-item" href="#user" aria-controls="user" role="tab"
				data-toggle="tab">
				<img src="/websiteManagement/images/icon_user_grey.png">用户管理
			</div>
			<div class="meun-item" href="#chan" aria-controls="chan" role="tab"
				data-toggle="tab">
				<img src="/websiteManagement/images/icon_change_grey.png">修改密码
			</div>
			<div class="meun-title">地区管理</div>
			<div class="meun-item" href="#scho" aria-controls="scho" role="tab"
				data-toggle="tab">
				<img src="/websiteManagement/images/icon_house_grey.png">地区管理
			</div>
			<div class="meun-item" href="#regu" aria-controls="regu" role="tab"
				data-toggle="tab">
				<img src="/websiteManagement/images/icon_rule_grey.png">规则管理
			</div>
			<div class="meun-item" href="#stud" aria-controls="stud" role="tab"
				data-toggle="tab">
				<img src="/websiteManagement/images/icon_card_grey.png">人员信息
			</div>
			<div class="meun-item" href="#sitt" aria-controls="sitt" role="tab"
				data-toggle="tab">
				<img src="/websiteManagement/images/icon_char_grey.png">座位管理
			</div>
		</div>
		<!-- 右侧具体内容栏目 -->
		<div id="rightContent">
